...
// 打开 SFTP 连接
export async function openSftpConnection(data) {
...
// 获取文件夹列表
export async function getDirList(data) {
...
// 截断文件
export async function truncateFile(data) {
...
// 修改文件权限
export async function changeFilePermissions(data) {
...
// 修改文件所有者
export async function changeFileOwner(data) {
...
// 修改文件所有组
export async function changeFileGroup(data) {
...
// 检查文件是否存在
export async function checkFileExistence(data) {
...
// 获取上传文件的 accessToken
export async function getUploadAccessToken(data) {
...
// 打包下载文件
export async function packageDownloadFile(data) {
...
// 暂停文件传输
export async function pauseFileTransfer(data) {
...
// 恢复文件传输
export async function resumeFileTransfer(data) {
...
// 传输失败重试
export async function retryFailedTransfer(data) {
...
// 重新上传文件
export async function reUploadFile(data) {
...
// 重新下载文件
export async function reDownloadFile(data) {
...
// 暂停所有传输
export async function pauseAllTransfers(data) {
...
// 恢复所有传输
export async function resumeAllTransfers(data) {
...
// 传输失败重试所有
export async function retryAllFailedTransfers(data) {
...
// 获取传输列表
export async function getTransferList(data) {
...
// 删除单个传输记录
export async function removeSingleTransfer(data) {
...
// 清空全部传输记录
export async function clearAllTransfers(data) {
...
// 传输打包全部已完成未删除的文件
export async function packageAllCompletedFiles(data) {
  return request(
