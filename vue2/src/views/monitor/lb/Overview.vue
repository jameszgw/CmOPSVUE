<template>
  <div v-loading="loading" class="tab-screen">
    <card-grid min="200px" gap="8px">
      ...
      <StatCard dense icon="el-icon-warning-outline" label="5xx 错误率"
      ...
      <StatCard dense icon="el-icon-cpu" label="上游健康"
    ...
    <card-grid class="fill" min="300px" gap="8px">
      ...
      <SectionCard dense scrollable title="流量概况" icon="el-icon-data-line">
        <InfoTable :rows="trafficRows" />
      </SectionCard>
      <SectionCard dense scrollable title="上游健康" icon="el-icon-cpu">
