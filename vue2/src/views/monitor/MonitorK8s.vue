...
export default {
  ...
  data() {
    return {
      tabs: [
        { key: "overview", label: "集群概览", icon: "el-icon-data-analysis" },
        { key: "nodes", label: "节点", icon: "el-icon-monitor" },
        { key: "pods", label: "工作负载", icon: "el-icon-box" },
        { key: "controlplane", label: "控制平面", icon: "el-icon-set-up" },
        { key: "netstorage", label: "网络与存储", icon: "el-icon-connection" },
        { key: "events", label: "事件", icon: "el-icon-bell" },
      ],
      tabComponents: {
        overview: "Overview",
        nodes: "Nodes",
